...
class SimpleCarController(Node):
    def __init__(self):
        ...
        self.MAX_STEERING_ANGLE = 0.47  # Max steering angle in radians (approx 30 degrees)
    ...
    def joy_callback(self, msg):
        ...
        if len(msg.axes) >= 2: 
            ...
            self.MAX_SPEED = 1             # Max linear speed in meters/second
            self.MAX_STEERING_ANGLE = 0.6 # Max steering angle in radians (approx 30 degrees)
